...
そうこうするうち２０２６年３月、Web記事 link:https://gihyo.jp/article/2026/02/htmx-introduction[gihyo.jp 「HTMLを拡張し⁠⁠、JSなしで動的UIを作るhtmx」, 嶌田喬行（しまだたかゆき）] を読んだ。この記事の冒頭にhtmxを使ったwebページのサンプルが紹介されていた。
